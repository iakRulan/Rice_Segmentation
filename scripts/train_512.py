...
# ---------------- Augmentation ----------------
def get_train_aug(img_size, light=False):
    if light:
        return A.Compose([
            ...
            A.CoarseDropout(num_holes_range=(1, 4), hole_height_range=(32, 96),
                            hole_width_range=(32, 96), fill=0, fill_mask=0, p=0.2),
...
def main():
    ...
    train_ds = CropDataset(tr_img, tr_lbl, mode, get_train_aug(args.img_size, light=args.light_aug))
    ...
    criterion = CombinedLoss(bce=1.0, dice=1.0, lovasz=0.0)
