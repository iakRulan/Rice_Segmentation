#!/bin/bash
# Dedicated rice single-class models with lovasz (rice at 0.8495, expect boost).
cd /root
mkdir -p /root/logs
...
run_one rice mit_b3 42 s4 130 24
run_one rice mit_b3 43 s4 130 24
echo "=== RICE DEDICATED DONE ==="
